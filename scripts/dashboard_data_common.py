...
<head>
  ...
  <style>
    ...
    .migration-controls {{ display: grid; grid-template-columns: 170px 240px minmax(260px, 360px) 520px; align-items: end; justify-content: start; }}
    .migration-controls .control {{ min-width: 0; }}
    .migration-controls select {{ box-sizing: border-box; width: 100%; }}
    .migration-controls .year-controls {{ display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); width: 520px; max-width: 100%; min-width: 0; }}
    @media (max-width: 1180px) {{
      .migration-controls {{ grid-template-columns: repeat(2, minmax(0, 1fr)); }}
      .migration-controls .year-controls {{ grid-column: 1 / -1; }}
    }}
